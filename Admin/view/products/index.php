        ...
        <form id="selecForm">
            <div class="p-2 text-center grid gap-x-1 gap-y-1 grid-cols-12 border border-transparent">
                <a href="Create.php"
                    ...
                    New Product</a>
                <input type="text" id="cusSearch" name="cusSearch" placeholder="Enter Product ID/Name/Phone Number"
            ...
            <div class="text-center grid grid-cols-12 border border-transparent">
                ...
                <div class="col-span-4"><label for="Name"
                        class="block font-medium text-gray-700 py-1 px-2 bg-pink-300 border border-pink-600">Name</label>
                </div>
                <div class="col-span-3"><label for="Quantity"
                        class="block font-medium text-gray-700 py-1 px-2 bg-pink-300 border border-pink-600">Quantity</label>
                </div>
                <div class="col-span-3"><label for="Date"
                        class="block font-medium text-gray-700 py-1 px-2 bg-pink-300 border border-pink-600">Date</label></div>
            ...
            <div class="grid grid-cols-12 border border-collapse border-transparent">
                ...
                <div class="col-span-4">
                    <p class="py-1 px-2 text-center border border-pink-600">nouch</p>
                </div>
                <div class="col-span-3">
                    <p class="py-1 px-2 text-center border border-pink-600">15</p>
                </div>
                <div class="col-span-3">
                    <p class="py-1 px-2 text-center border border-pink-600">08/12/2024</p>
                </div>
                <div class="col-span-1">
