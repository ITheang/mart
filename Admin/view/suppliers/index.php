...
<body class="bg-gray-100 p-8">
    <div class="max-w-3xl mx-auto bg-white p-5 rounded-lg shadow-xl">
        <!-- header -->
        <h1 class="text-xl font-bold mb-4">Supplier List</h1>
        <form id="selecForm">
            <div class="p-2 text-center grid gap-x-1 gap-y-1 grid-cols-12 border border-transparent">
                <a href="Create.php"
                    ...
                    New Supplier</a>
                <input type="text" id="cusSearch" name="cusSearch" placeholder="Enter Supplier ID/Name/Phone Number"
            ...
            <div class="text-center grid grid-cols-12 border border-transparent">
                ...
                <div class="col-span-3"><label for="Name"
                        class="block font-medium text-gray-700 py-1 px-2 bg-pink-300 border border-pink-600">Name</label>
                </div>
                <div class="col-span-3"><label for="ContatctName"
                        class="block font-medium text-gray-700 py-1 px-2 bg-pink-300 border border-pink-600">ContatctName</label>
                </div>
                <div class="col-span-4"><label for="PhoneNumber"
                        class="block font-medium text-gray-700 py-1 px-2 bg-pink-300 border border-pink-600">Phone    Number</label></div>
            ...
            <div class="grid grid-cols-12 border border-collapse border-transparent">
                <div class="col-span-1">
                    <p class="py-1 px-2 text-center border border-pink-600">0001</p>
                </div>
                <div class="col-span-5">
                    <p class="py-1 px-2 border border-pink-600">nouch</p>
                </div>
                <div class="col-span-3">
                    <p class="py-1 px-2 text-center border border-pink-600">som soknouch</p>
                </div>
