...
<body>
    ...
    <form class="form" action="model/login.php" method="post">
        ...
        <input class="input" name="txtuser" placeholder="username" type="text">
        <input class="input" name="txtpassword" placeholder="Password" type="password">
        <div class="login-with">
            ...
            <div class="button-log">
                <svg class="icon" height="56.693px" id="Layer_1" version="1.1" viewBox="0 0 56.693 56.693"
        ...
        <div class="row">
            <div class="col-xl-12">
                <?php
                if (isset($_SESSION['msg-login']) != null) {
                    ?>
                    <div class="alert alert-success" role="alert">
                        <?php echo $_SESSION['msg-login'];
                        session_destroy();
